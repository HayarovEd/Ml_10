...
android {
    namespace = "org.zaimy.bez.otkaza.komar"
    compileSdk = 34

    defaultConfig {
        applicationId = "org.zaimy.bez.otkaza.komar"
        minSdk = 21
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    signingConfigs {
        getByName("debug") {
            storeFile = file("ID526.keystore")
            keyAlias = "mypass"
            storePassword = "org.zaimy.bez.otkaza.komar"
            keyPassword = "org.zaimy.bez.otkaza.komar"
        }
        create("release") {
            keyAlias = "mypass"
            keyPassword = "org.zaimy.bez.otkaza.komar"
